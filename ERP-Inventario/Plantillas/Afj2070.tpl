...
<head>
   ...
   <script>
      ...
      function f_BuscarTipo() {
         ...
         // alert(lcSend);
         $.post("Afj2070.php",lcSend).done(function(p_cResult) {
            // console.log(p_cResult);
            if (!isJson(p_cResult.trim())) {
               Swal.fire('ERROR 404');
               return;
...
<div id="header"></div>
<form action="Afj2070.php" method="post" enctype="multipart/form-data" id="poForm">
   ...
   <div class="container-fluid">
      <div class="card-header text-dark " style="background:#fbc804; color:black;">
         <div class="input-group input-group-sm d-flex justify-content-between KTitCar">
            <div class="col text-left"><strong>REPORTE POR CARACTERÍSTICAS</strong></div>
      ...
      <div class="card-body" >
         ...
         <div style="padding-left: 5rem;">
            ...
            <div class="input-group mb-1">
               <div class="input-group-prepend col-lg-3 px-0">
                  <span class="input-group-text w-100 bg-ucsm">Para Inv./Reasig.</span>
               </div>
               <input type="text" maxlength="1" name="paData[CINDICA]" class="form-control text-uppercase col-lg-1 black-input" placeholder="I/R" >
            </div>
         </div>
