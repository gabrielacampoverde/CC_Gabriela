...
<head>
   ...
   <script>
      ...
      function f_buscarEmpleado() {
         ...
         // alert(lcSend);
         $.post("Afj2080.php", lcSend).done(function(lcResult) {
            // alert(lcResult);
...
<div id="header"></div>
<form action="Afj2080.php" method="post" enctype="multipart/form-data" id="poForm">
   ...
   <div class="container-fluid">
      <div class="card-header text-dark " style="background:#fbc804; color:black;">
         <div class="input-group input-group-sm d-flex justify-content-between KTitCar">
            <div class="col text-left"><strong>REPORTE POR VALORES</strong></div>
         ...
         <div class="card-body" >
            ...
            <div style="padding-left: 5rem;">
               ...
               <div class="input-group mb-1">
                  ...
                  <input type="date" class="form-control text-uppercase black-input col-lg-8" name="paData[DFECINI]" id="fechaInicial" value="">
               </div>
               <div class="input-group mb-1">
                  <div class="input-group-prepend col-lg-3 px-0">
                  ...
                  <tbody>
                     ...
                     {foreach from=$saDatos item=i}
                        <tr class="text-center" class="custom-select" multiple>
                           ...
                           <td class="text-right">{$i['NDEPPER']|number_format:2:".":","}</td>
                           <td class="text-right">{$i['NRETIRO']|number_format:2:".":","}</td>
                           <td class="text-right">{$i['NSUMDEP']|number_format:2:".":","}</td>
                           <td class="text-right">{$i['NVALNET']|number_format:2:".":","}</td>
                        </tr>
                        {$k = $k + 1}
                        {$lnMoncal = $lnMoncal + $i['NMONCAL']}
                        {$lnDeprec = $lnDeprec + $i['NDEPREC']}
                        {$lnDepPer = $lnDepPer + $i['NDEPPER']}
                        {$lnRetiro = $lnRetiro + $i['NRETIRO']}
                        {$lnSumDep = $lnSumDep + $i['NSUMDEP']}
                        {$lnValNet = $lnValNet + $i['NVALNET']}
                     {/foreach}
                     <tr class="text-center" class="custom-select" multiple>
                        ...
                        <td class="text-center"></td>
                        <td class="text-center"></td>
                        <td class="text-right">{$lnMoncal|number_format:2:".":","}</td>
                        <td class="text-right">{$lnDeprec|number_format:2:".":","}</td>
                        <td class="text-right">{$lnDepPer|number_format:2:".":","}</td>
                        <td class="text-right">{$lnRetiro|number_format:2:".":","}</td>
                        <td class="text-right">{$lnSumDep|number_format:2:".":","}</td>
                        <td class="text-right">{$lnValNet|number_format:2:".":","}</td>
                     </tr>
                  </tbody>
               </table>
            </div>
