...
<head>
   ...
   <script>
      function f_buscarOpcion() {
         ...
         var lcSend = "Id=buscarRol&pcBusOpc=" + lcBusOpc.value;
         xhttp.open("POST", "Adm1060.php", true);
...
<body onload="Init()">
<div id="header"></div>
<form action="Adm1060.php" method="post" enctype="multipart/form-data" id="poForm" >
   ...
   <div class="container-fluid">
      <div class="card-header bg-ucsm" style="background: #fbc804">
         <div class="input-group input-group-sm d-flex justify-content-between" style="color: black; font-weight: 500">
            <strong>ASIGNAR ROLES A MODULO</strong>
      ...
      {else if $snBehavior eq 1}
         ...
         <div class="card text-center ">
            <div class="p-1">
               ...
               <div class="input-group-prepend bg-ucsm px-4 col-2 justify-content-end">MODULO</div>
               <input type="text" placeholder="NUEVO/AAA" name="paData[CCODMOD]" value="{$saData['CCODMOD']}" class="form-control col-2" {if $saData['CNUEVO'] eq 'N'} readonly {/if} required>
               <input type="text" placeholder="NUEVO/DESCRIPCION" name="paData[CNOMBRE]" value="{$saData['CNOMBRE']}" class="form-control col-6" required>
               </div>
               <div class="input-group mb-1">
                  <div class="input-group-prepend col-2 bg-ucsm px-2 justify-content-end">ROL</div>
