...
<div id="header"></div>
<form action="Afj1001.tpl" method="post" enctype="multipart/form-data" id="poForm">
      ...
      {if $snBehavior eq 0}
         <div class="card-header text-dark" style="background:#fbc804; color:black;">
            <div class="input-group input-group-sm d-flex justify-content-between KTitCar">
               <div class="col text-left"><strong>MENÚ DE BAJAS, DONACIONES Y REMATES</strong></div>
         ...
         <div class="row text-center">
            <div class="col-6 col-sm-3">
               <a class="btn btn-outline-warning justify-content-start text-dark border border-dark col-3 col-12" href="Afj1120.php">
                  ...
                  <div><br><h5><b>POR CENTRO DE RESPONSAILIDAD</b></h5></div>
               </a>
            </div>
            <div class="col-6 col-sm-3">
               <a class="btn btn-outline-warning justify-content-start text-dark border border-dark col-3 col-12" href="Afj1160.php">
                  <div><img src="img/baja_af.png" width="60" height="60" style="opacity: 0.5;"></div>
                  <div><br><h5><b>POR ACTIVO FIJO</b></h5></div>
               </a>
            </div>
            <div class="col-6 col-sm-3">
               <a class="btn btn-outline-danger justify-content-left text-dark border border-dark col-md-3 col-sm-12" href="Afj1003.php">
