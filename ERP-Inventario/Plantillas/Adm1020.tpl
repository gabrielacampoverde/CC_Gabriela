...
<body onload="Init()">
<div id="header"></div>
<form action="Adm1020.php" method="post" enctype="multipart/form-data" id="poForm" >
   ...
   <div class="container-fluid">
      <div class="card-header bg-ucsm" style="background: #fbc804">
         <div class="input-group input-group-sm d-flex justify-content-between" style="color: black; font-weight: 500">
            <strong>MANTENIMIENTO DE PANTALLAS</strong>
      ...
      {if $snBehavior eq 0}
         {* <div class="card">
            ...
            <div class="card-footer text-center">
               <button type="submit" name="Boton" value="Nuevo" class="btn bg-ucsm col-md-2" ><i class="fas fa-share"></i>&nbsp;&nbsp;Nuevo</button>
               {if $saDatos neq NULL}
                  <button type="submit" name="Boton" value="Editar" class="btn  btn-info col-md-2"><i class="fas fa-edit"></i>&nbsp;&nbsp;Editar</button>
               {/if}
               <button type="submit" name="Boton" value="Salir" class="btn btn-danger  col-md-2" ><i class="fas fa-undo-alt"></i>&nbsp;&nbsp;Salir</button>
            </div>
         </div> *}
         <div class="card-body">
               ...
               <div class="card-body">
                  <div class="input-group mb-3 d-flex justify-content-center">
                     <div class="input-group-prepend">
                        <label class="input-group-text bg-ucsm">CODIGO/NOMBRE</label>
                     </div>
                     <input id="pcBusOpc" type="text"  name="paData[CBUSOPC]" class="form-control uppercase" style="text-transform: uppercase;" onblur="f_ValidarBusqueda();">
                     <div class="input-group-append">
                        <button id="p_Buscar" type="submit" name="Boton" value="Buscar" class="btn btn-outline-info" formnovalidate disabled>Buscar</button>
                     </div>
                  </div>
                  <div class="mh-60">
                     <table class="table table-sm table-hover text-center">
                        <thead class="text-center" style="background:#000000; color:white">
                           ...
                           <th class="text-left" scope="col">Imagen</th>
                           <th scope="col">Estado</th>
                           <th scope="col"><img src="css/feather/check-square-white.svg"></th>
                           </tr>
                        </thead>
                        <tbody>
                           {foreach from = $saDatos item = i} 
                              <tr>
                              <td scope="row">{$i['CCODOPC']}</td> 
                              <td class="text-left">{$i['CDESCRI']}</td>
                              <td class="text-left">{$i['CIMAGE']}</td>
                              <td>
                                 {if $i['CESTADO'] eq 'A'}
                                    <img src="css/svg/ic_active_24.svg">
                                 {elseif $i['CESTADO'] eq 'I'}
                              ...
                              <td><input name="pcCodOpc" type="radio" value="{$i['CCODOPC']}" required></td> 
                              </tr> 
                           {/foreach}
                        </tbody>
                     </table>
      ...
      {else if $snBehavior eq 1}
         ...
         <div class="card-body" >
            ...
            <div class="input-group mb-3">
               ...
               <input type="text" placeholder="NUEVO/AAA0000" name="paData[CCODOPC]" value="{$saData['CCODOPC']}" class="form-control" maxlength="7" required>
            </div>
            <div class="input-group mb-3 d-flex align-items-start">
               ...
               <textarea name="paData[CDESCRI]" class="form-control no-resize" maxlength="200" rows="4" style="text-transform: uppercase;" required>{$saData['CDESCRI']}</textarea>
            </div>
            <div class="input-group mb-3">
               <div class="input-group-prepend">
                  <span class="input-group-text bg-sc-ucsm" id="inputGroup-sizing-default">Imagen  </span>
               </div>
               <input type="text"  name="paData[CIMAGE]" value="{$saData['CIMAGE']}" class="form-control" maxlength="50" required>
            </div>
            <div class="input-group mb-3 d-flex justify-content-center">
               <div class="input-group-prepend">
