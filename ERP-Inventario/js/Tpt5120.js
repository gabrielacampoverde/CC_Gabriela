$(document).ready(function() {
    ...
    if (cTestSeg2023.length > 0) {
        const grafico = new Chart( $("#miGrafico26"), getChartConfig26(dataSeg2023,labelsSeg2023));
...
$(document).ready(function() {
    ...
    if (cTestSegInc2023.length > 0) {
        const grafico = new Chart( $("#miGrafico27"), getChartConfig27(dataSegInc2023,labelsSegInc2023));
        // const grafico = new Chart( ctx, getChartConfig(data,labels));
    }
});
...
$(document).ready(function() {
    ...
    if (cTestSegMont2023.length > 0) {
        const grafico = new Chart( $("#miGrafico28"), getChartConfig28(dataSegMont2023,labelsSegMont2023));
        // const grafico = new Chart( ctx, getChartConfig(data,labels));
    }
});
...
$(document).ready(function() {
    ...
    if (cTestSegInc22023.length > 0) {
        const grafico = new Chart( $("#miGrafico29"), getChartConfig29(dataSegInc22023,labelsSegInc22023));
        // const grafico = new Chart( ctx, getChartConfig(data,labels));
    }
});
