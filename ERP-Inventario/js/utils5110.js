function getChartConfig22 (dataSeg2023,labelsSeg2023){
...
function getChartConfig23 (dataSegInc2023,labelsSegInc2023){
    // console.log(data);
    // console.log(data1);
    // console.log(labels);
    const config = {
...
function getChartConfig24 (dataSegMont2023,labelsSegMont2023){
    // console.log(data);
    // console.log(data1);
    // console.log(labels);
    const config = {
...
function getChartConfig25 (dataSegInc22023,labelsSegInc22023){
    // console.log(data);
    // console.log(data1);
    // console.log(labels);
    const config = {
