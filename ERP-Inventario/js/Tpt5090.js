$(document).ready(function() {
    let datosSeg2023 = document.getElementById('DatosE2023');
    ...
    if (cTestSeg2023.length > 0) {
        const grafico = new Chart( $("#miGrafico18"), getChartConfig18(dataSeg2023,labelsSeg2023));
        // const grafico = new Chart( ctx, getChartConfig(data,labels));
    }
});

$(document).ready(function() {
    let datosSegInc2023 = document.getElementById('DatosE2023');
    ...
    if (cTestSegInc2023.length > 0) {
        const grafico = new Chart( $("#miGrafico19"), getChartConfig19(dataSegInc2023,labelsSegInc2023));
        // const grafico = new Chart( ctx, getChartConfig(data,labels));
    }
});

$(document).ready(function() {
    let datosSegMont2023 = document.getElementById('DatosE2023');
    ...
    if (cTestSegMont2023.length > 0) {
        const grafico = new Chart( $("#miGrafico20"), getChartConfig20(dataSegMont2023,labelsSegMont2023));
        // const grafico = new Chart( ctx, getChartConfig(data,labels));
    }
});

$(document).ready(function() {
    let datosSegInc22023 = document.getElementById('DatosE2023');
    ...
    if (cTestSegInc22023.length > 0) {
        const grafico = new Chart( $("#miGrafico21"), getChartConfig21(dataSegInc22023,labelsSegInc22023));
        // const grafico = new Chart( ctx, getChartConfig(data,labels));
    }
});
