function getChartConfig18 (dataSeg2023,labelsSeg2023){
...
function getChartConfig19 (dataSegInc2023,labelsSegInc2023){
    // console.log(data);
    // console.log(data1);
    // console.log(labels);
    const config = {
...
function getChartConfig20 (dataSegMont2023,labelsSegMont2023){
    // console.log(data);
    // console.log(data1);
    // console.log(labels);
    const config = {
...
function getChartConfig21 (dataSegInc22023,labelsSegInc22023){
    // console.log(data);
    // console.log(data1);
    // console.log(labels);
    const config = {
