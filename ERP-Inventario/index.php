...
function fxIniciar() {
   ...
   if (isset($_SESSION['GCIDCATE']) && $_SESSION['GCIDCATE'] == 'Auspicio') { #AUSPICIOS
      fxHeader('Aus1030.php');
   } elseif (isset($_SESSION['GCIDCATE']) && $_SESSION['GCIDCATE'] == 'CajaChica') { #CAJA CHICA
      fxHeader('Erp5140.php');
   } else {
      fxHeader("Mnu1000.php");
   }
   fxHeader("Mnu1000.php");
